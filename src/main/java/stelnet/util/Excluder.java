...
public class Excluder {
    ...
    private static List<MarketFilter> getFactionFilters(
        List<MarketFilter> filters
    ) {
    ...
    private static List<MarketFilter> getMarketFilters(
        List<MarketFilter> filters
    ) {
    ...
    private static List<MarketFilter> getSystemFilters(
        List<MarketFilter> filters
    ) {
    ...
    private static List<MarketFilter> getTagFilters(
        List<MarketFilter> filters
    ) {
    ...
    private static List<String> getStrings(String path) {
        ...
        try {
            JSONArray config = Global
                .getSettings()
                .getMergedSpreadsheetDataForMod("id", path, "stelnet");
