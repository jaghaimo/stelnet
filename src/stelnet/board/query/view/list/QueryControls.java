...
public class QueryControls extends HeadingWithButtons {
    ...
    public void render(TooltipMakerAPI tooltip) {
        ...
        renderHeading(tooltip, query.isEnabled());
        overlapQueryHeading(tooltip, query.isEnabled(), query.getType() + " #" + query.getNumber());
        UIComponentAPI deleteComponent = renderFirst(new DeleteButton(query), tooltip);
