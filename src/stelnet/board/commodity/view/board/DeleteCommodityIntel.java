...
public class DeleteCommodityIntel extends C2Button {
    ...
    public DeleteCommodityIntel(final String commodityId, final IntelTracker intelTracker) {
        super(new Size(190, UiConstants.DEFAULT_BUTTON_HEIGHT), L10n.commodity("DELETE_THIS"), true);
    ...
    public void onPrompt(final TooltipMakerAPI tooltipMaker) {
        tooltipMaker.addPara(L10n.commodity("DELETE_THIS_CONFIRMATION"), Misc.getTextColor(), 0f);
    }
}
