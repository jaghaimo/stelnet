...
public class SingleMarketButton extends AreaCheckbox {

    public SingleMarketButton(int i, final String commodityId, final MarketAPI market, final IntelTracker tracker) {
